...
bool MarkdownReader::canRead(QIODevice* device)
{
...
void MarkdownReader::readData(QIODevice* device)
{
...
void MarkdownReader::readContent()
{
...
void MarkdownReader::readStyles()
{
...
void MarkdownReader::readDocument()
{
...
void MarkdownReader::readParagraph()
{
...
void MarkdownReader::readParagraphProperties(Style& style, bool allowstyles)
{
...
void MarkdownReader::readRunProperties(Style& style, bool allowstyles)
{
	while (m_xml.readNextStartElement()) {
		QStringRef value = m_xml.attributes().value("w:val");
